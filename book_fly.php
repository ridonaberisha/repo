<?php 
   include 'conn.php';
   $id_fly=$_GET['id_fly'];
   $sql="SELECT * from fly where id_fly='$id_fly'";
                ...
                <h2>BOOK FLY</h2>
                        ...
                        <table id="t01">
                            <tr>
                                ...
                                <th style="background:#3c3c3c;color:#ff9900">From city airport</th>
                                <th style="background:#3c3c3c;color:#ff9900">To city airport</th> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $rows['from_city_airport']; ?></td>
                                <td><?php echo $rows['to_city_airport']; ?></td>
                      ...
                      <form  method="post" action="book_fly_p.php">
                         <table id="t02">
                             
                                <input name="from_city_airport" type="hidden"  value="<?php echo $rows['from_city_airport']; ?>">
                                <input name="to_city_airport" type="hidden"   value="<?php echo $rows['to_city_airport']; ?>">
